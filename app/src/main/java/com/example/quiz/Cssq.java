...
public class Cssq extends BaseAdapter implements ListAdapter {
    ...
    public Cssq(Css css, String[] question, String[] a, String[] b, String[] c, String[] d, String[] answer) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if ((position == 2)&&(r2.isChecked())) {
                ...
                else if ((position == 4) &&(r2.isChecked())) {
