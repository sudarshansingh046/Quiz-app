...
public class pythonq extends BaseAdapter implements ListAdapter {
    ...
    public pythonq(Python python, String[] question, String[] a, String[] b, String[] c, String[] d, String[] answer) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if ((position == 1) &&(r4.isChecked())){
                ...
                else if ((position == 3)&&(r3.isChecked())) {

                    count++;
                    t2.setText("right answer");
                    finalConvertView.setBackgroundColor(Color.GREEN);
                }
                else if ((position == 4) &&(r4.isChecked())) {
