...
public class Cq extends BaseAdapter implements ListAdapter {
    ...
    public Cq(C cl, String[] question, String[] a, String[] b, String[] c, String[] d, String[] answer) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if ((position == 1) &&(r2.isChecked())){
                ...
                else if ((position == 3)&&(r1.isChecked())) {
